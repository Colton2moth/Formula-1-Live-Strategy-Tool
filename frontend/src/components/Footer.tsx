    ...
    <footer className="footer">
      ...
      <nav className="footer-links" aria-label="Footer links">
        <a
          ...
          href="https://github.com/Colton2moth/Formula-1-Live-Strategy-Tool"
          target="_blank"
          rel="noreferrer"
        >
          <GitHubIcon />
        ...
        <a
          className="footer-link"
          href="https://www.linkedin.com/in/colton-tumoth/"
          target="_blank"
          rel="noreferrer"
        >
          <LinkedInIcon />
          <span className="footer-link-label">Colton Tumoth</span>
        </a>
      </nav>
    </footer>
  );
